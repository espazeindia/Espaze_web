...
function Products() {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center gap-5 mt-5">
        <div className="flex items-center justify-between gap-5">
          ...
          >
            <Add />
            Add to Inventory
            <div className={`absolute hidden group-hover:block top-[100%] text-xs p-2 rounded-lg shadow-lg
              ${
      ...
      <div className={`${theme ? " bg-white" : " bg-zinc-800"} shadow-md  p-4 rounded-lg mt-8 `}>
