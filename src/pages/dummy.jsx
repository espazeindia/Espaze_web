        ...
        <div className="flex flex-col overflow-y-auto md:flex-row relative">
          ...
          <main className="flex flex-col items-center justify-center p-6 sm:p-12">
            ...
            <div className="w-full">
              ...
              {/* selerLogin */}
              <div>
                <h2 className="mb-4 text-2xl text-violet-800 font-bold text-center">
                  Seller Login
                </h2>

                <div className="rounded-lg p-1 py-1.5 flex w-full justify-center gap-3 mt-4 mb-6 ">
                  <div
                    onClick={() => setActiveTab("seller")}
                    className={`cursor-pointer py-2 px-2 text-sm border-2 font-medium rounded-md text-center w-1/2 ${
                      activeTab === "seller"
