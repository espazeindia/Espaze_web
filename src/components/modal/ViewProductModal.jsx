      ...
      <ModalDialog size="lg" sx={theme ? {backgroundColor : "#ffffff" , border : "none" } : { backgroundColor: "#18181b", border: "none" }}>
        ...
        <DialogContent className="h-[20vh] w-[50vw] overflow-auto p-4">
          <div className="flex flex-col gap-4">
            ...
            <p className={`${theme ? "text-zinc-800":"text-zinc-300"} mt-3 leading-relaxed`}>{data?.description}</p>

            <div className={`grid grid-cols-2 gap-4 mt-3 ${theme ? "text-zinc-700":"text-zinc-200"}`}>
              <p>
