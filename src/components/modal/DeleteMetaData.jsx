...
function DeleteProductModal({ isOpen, onClose, deleteProduct, setOnboardingData }) {
    ...
    <Modal open={isOpen} onClose={onClose}>
      <ModalDialog size="lg" sx={ theme ? { backgroundColor: "#ffffff", border: "none" } : { backgroundColor: "#18181b", border: "none" }}>
        ...
        <DialogContent className=" w-[40vw] overflow-scroll sideBarNone">
          ...
          <div className={`${ theme ? "text-black":"text-white"} mt-4 text-center`}>Are you sure you want to delete ?</div>
