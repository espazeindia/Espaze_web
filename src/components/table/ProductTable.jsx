...
function ProductTable({ products, setProducts, checkedIds, setCheckedIds }) {
  const {theme} = useMode();
...
{/* 
            ...
            <TableCell>
              <div className="flex justify-center  text-gray-500">
                ...
                <button className={`hover:cursor-pointer ml-3 ${theme?"text-green-600 hover:text-green-700":"text-green-400 hover:text-green-700"} `}
                  onClick={() => {
                    handleProductView(product);
                  }}>
                  <Add fontSize="small"/>
